...
@Api(value = "db", description = "the db API")
public interface DbApi {

    @ApiOperation(value = "", nickname = "login", notes = "login DB sysytem ", response = EmptyDto.class, tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<EmptyDto> login(@ApiParam(value = ""  )  @Valid @RequestBody RetryForm body);


    @ApiOperation(value = "", nickname = "logout", notes = "logout system ", response = EmptyDto.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "SUCCCESS", response = EmptyDto.class) })
    @RequestMapping(value = "/db/logout",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<EmptyDto> logout();
